...
export default function FormCustomer({ setSelect, selectItem, trainerData }) {
  ...
  const [username, setUsername] = useState(
    selectItem ? selectItem.username : ""
  );
  const [password, setPassword] = useState(
    selectItem ? selectItem.password : ""
  );
  const [trainer, setTrainer] = useState(selectItem ? selectItem.trainer : "");
  const [userPlansPurchase, setUserPlansPurchase] = useState(
    selectItem ? selectItem.userPlansPurchase : ""
  );
    ...
    <div id="equipmentAddModal" className="modal">
      <div className="modal-content entity-add-form">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <input
            type="number"
            id="userPlansPurchase"
            value={userPlansPurchase}
            onChange={(e) => setUserPlansPurchase(e.target.value)}
            disabled={trainerData}
          />
          <div>
            <label>Tasks:</label>
